...
//                            String service1 = endpoint.getString("serviceName");
//                            content.put("clientName", service1);
...
//                            JSONObject endpoint = anno.getJSONObject("endpoint");
//                            String service1 = endpoint.getString("serviceName");
//                            content.put("serverName", service1);
...
////                        content.put("api", content.get("service1") + "." + "message_received");
////                    }
////                } else {
