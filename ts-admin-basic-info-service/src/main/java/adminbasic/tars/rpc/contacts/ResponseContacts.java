...
public class ResponseContacts {
	...
	public ContactsTars getData() {
		return data;
	}

	public void setData(ContactsTars data) {
		this.data = data;
	}
	...
	public ResponseContacts(int status, String msg, ContactsTars data) {
		this.status = status;
		this.msg = msg;
		this.data = data;
	}
	...
	public boolean equals(Object obj) {
		...
		if (!(obj instanceof ResponseContacts)) {
			return false;
		}
		ResponseContacts other = (ResponseContacts) obj;
		return (
	...
	static ContactsTars cache_data;
	static { 
		cache_data = new ContactsTars();
	}

	public void readFrom(TarsInputStream _is) {
		this.status = _is.read(status, 0, false);
		this.msg = _is.readString(1, false);
		this.data = (ContactsTars) _is.read(cache_data, 2, false);
	}
