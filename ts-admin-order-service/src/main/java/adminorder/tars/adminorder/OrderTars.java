...
public class OrderTars {
	...
	public OrderTars(adminorder.tars.rpc.order.OrderTars orderTars){
		this.id= orderTars.getId();
		this.boughtDate=orderTars.getBoughtDate();
		this.travelDate=orderTars.getTravelDate();
		this.travelTime=orderTars.getTravelTime();
		this.accountId=orderTars.getAccountId();
	...
	public OrderTars(adminorder.tars.rpc.orderother.OrderTars orderTars){
		this.id= orderTars.getId();
		this.boughtDate=orderTars.getBoughtDate();
		this.travelDate=orderTars.getTravelDate();
		this.travelTime=orderTars.getTravelTime();
