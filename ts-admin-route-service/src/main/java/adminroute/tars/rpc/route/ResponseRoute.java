...
public class ResponseRoute {
	...
	public RouteTars getData() {
		return data;
	}

	public void setData(RouteTars data) {
		this.data = data;
	}
	...
	public ResponseRoute(int status, String msg, RouteTars data) {
		this.status = status;
		this.msg = msg;
		this.data = data;
	}
	...
	public boolean equals(Object obj) {
		...
		if (!(obj instanceof ResponseRoute)) {
			return false;
		}
	...
	static RouteTars cache_data;
	static { 
		cache_data = new RouteTars();
	}

	public void readFrom(TarsInputStream _is) {
		this.status = _is.read(status, 0, false);
		this.msg = _is.readString(1, false);
		this.data = (RouteTars) _is.read(cache_data, 2, false);
	}
