...
public class ResponseDouble {
	...
	public ResponseDouble(int status, String msg, double data) {
		this.status = status;
		this.msg = msg;
		this.data = data;
	}
	...
	public boolean equals(Object obj) {
		...
		if (!(obj instanceof ResponseDouble)) {
			return false;
		}
		ResponseDouble other = (ResponseDouble) obj;
		return (
	...
	public void readFrom(TarsInputStream _is) {
		...
		this.data = _is.read(data, 2, false);
	}
