...
public class PaymentTypeTars {
	...
	public PaymentTypeTars() {
	}

	public PaymentTypeTars(String name, int index) {
		this.name = name;
		this.index = index;
	}
	...
	public boolean equals(Object obj) {
		...
		if (!(obj instanceof PaymentTypeTars)) {
			return false;
		}
		PaymentTypeTars other = (PaymentTypeTars) obj;
		return (
