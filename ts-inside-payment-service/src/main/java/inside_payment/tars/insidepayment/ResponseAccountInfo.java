...
public class ResponseAccountInfo {
	...
	public AccountInfoTars data = null;
	...
	public AccountInfoTars getData() {
		return data;
	}

	public void setData(AccountInfoTars data) {
		this.data = data;
	}
	...
	public ResponseAccountInfo(int status, String msg, AccountInfoTars data) {
		this.status = status;
		this.msg = msg;
		this.data = data;
	}
	...
	public boolean equals(Object obj) {
		...
		if (!(obj instanceof ResponseAccountInfo)) {
			return false;
		}
		ResponseAccountInfo other = (ResponseAccountInfo) obj;
		return (
	...
	static AccountInfoTars cache_data;
	static { 
		cache_data = new AccountInfoTars();
	}

	public void readFrom(TarsInputStream _is) {
		this.status = _is.read(status, 0, false);
		this.msg = _is.readString(1, false);
		this.data = (AccountInfoTars) _is.read(cache_data, 2, false);
	}
