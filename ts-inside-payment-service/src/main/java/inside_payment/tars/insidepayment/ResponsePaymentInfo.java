...
public class ResponsePaymentInfo {
	...
	public PaymentInfoTars data = null;
	...
	public PaymentInfoTars getData() {
		return data;
	}

	public void setData(PaymentInfoTars data) {
		this.data = data;
	}
	...
	public ResponsePaymentInfo(int status, String msg, PaymentInfoTars data) {
		this.status = status;
		this.msg = msg;
		this.data = data;
	}
	...
	public boolean equals(Object obj) {
		...
		ResponsePaymentInfo other = (ResponsePaymentInfo) obj;
		return (
	...
	static PaymentInfoTars cache_data;
	static { 
		cache_data = new PaymentInfoTars();
	}

	public void readFrom(TarsInputStream _is) {
		this.status = _is.read(status, 0, false);
		this.msg = _is.readString(1, false);
		this.data = (PaymentInfoTars) _is.read(cache_data, 2, false);
	}
