...
@TarsStruct
public class ResponsePaymentInfoList {
	...
	public java.util.List<PaymentInfoTars> data = null;
	...
	public java.util.List<PaymentInfoTars> getData() {
		return data;
	}

	public void setData(java.util.List<PaymentInfoTars> data) {
		this.data = data;
	}

	public ResponsePaymentInfoList() {
	}

	public ResponsePaymentInfoList(int status, String msg, java.util.List<PaymentInfoTars> data) {
		this.status = status;
		this.msg = msg;
		this.data = data;
	}
	...
	public boolean equals(Object obj) {
		...
		if (!(obj instanceof ResponsePaymentInfoList)) {
			return false;
		}
		ResponsePaymentInfoList other = (ResponsePaymentInfoList) obj;
		return (
	...
	public void readFrom(TarsInputStream _is) {
		...
		this.data = (java.util.List<PaymentInfoTars>) _is.read(cache_data, 2, false);
	}
