...
public class ResponsePayment {
	...
	public PaymentTars getData() {
		return data;
	}

	public void setData(PaymentTars data) {
		this.data = data;
	}
	...
	public ResponsePayment(int status, String msg, PaymentTars data) {
		this.status = status;
		this.msg = msg;
		this.data = data;
	}
	...
	public boolean equals(Object obj) {
		...
		ResponsePayment other = (ResponsePayment) obj;
		return (
	...
	static PaymentTars cache_data;
	static { 
		cache_data = new PaymentTars();
	}

	public void readFrom(TarsInputStream _is) {
		this.status = _is.read(status, 0, false);
		this.msg = _is.readString(1, false);
		this.data = (PaymentTars) _is.read(cache_data, 2, false);
	}
