...
import other.tars.orderother.SoldTicketTars;
...
public class SoldTicket {
    ...
    public SoldTicketTars toTars(){
        SoldTicketTars soldTicketTars =new SoldTicketTars();
        soldTicketTars.setTravelDate(this.travelDate.getTime());
        soldTicketTars.setTrainNumber(this.trainNumber);
        soldTicketTars.setNoSeat(this.noSeat);
        soldTicketTars.setBusinessSeat(this.businessSeat);
        soldTicketTars.setFirstClassSeat(this.firstClassSeat);
        soldTicketTars.setSecondClassSeat(this.secondClassSeat);
        soldTicketTars.setHardSeat(this.hardSeat);
        soldTicketTars.setSoftSeat(this.softSeat);
        soldTicketTars.setSoftBed(this.softBed);
        soldTicketTars.setHardBed(this.hardBed);
        soldTicketTars.setHighSoftBed(this.highSoftBed);
        return soldTicketTars;
    }
}
