...
public class UserServiceImpl implements UserService {
    ...
    private static final String AUHT_SERVICE_URI = "http://ts-auth-service1:12340/api/v1";
    ...
    public Response saveUser(UserDto userDto, HttpHeaders headers) {
        ...
        if (user1 == null) {
            ...
            log.info("Send authorization message to ts-auth-service1....");
    ...
    private Response createDefaultAuthUser(AuthDto dto) {
        ...
        ResponseEntity<Response<AuthDto>> res  = restTemplate.exchange("http://ts-auth-service1:12340/api/v1/auth",
                HttpMethod.POST,
                entity,
